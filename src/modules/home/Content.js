...
const Content = () => {
    return (
        <div className="flex ">
            <div>
            <h1 className="py-5 pl-6 text-4xl font-bold text-[rgba(55,53,53,0.86)] ">CHÚC MỘT NGÀY TỐT LÀNH !</h1>
            <div className="pt-3 pl-2 mt-3 ml-6 border rounded-lg border-darkStroke bg-blue-400 w-[880px] flex items-center justify-around">
                <div className="">
